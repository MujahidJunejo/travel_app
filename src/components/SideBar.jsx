			...
			<div className="dlabnav-scroll">
				...
				<div className="dropdown header-profile2 ">
					<div className="header-info2 text-center">
						...
						<div>
							<a href="javascript:void(0);" className="btn btn-md text-secondary">Contact Us</a>
						</div>
					</div>
				</div>
				<div className="copyright">
					<p className="text-center"><strong>Travl Hotel Admin Dashboard</strong> © 2021 All Rights Reserved</p>
